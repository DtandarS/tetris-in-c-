...
class Pieces {
  ...
  public: 
    ...
    int HorizontalInitalPositon(int PieceToDraw, int PossibleRotations);
    int VerticalInitalPosition(int PieceToDraw, int PossibleRotations);
...
return InitialPosition [PieceToDraw][PossibleRotations][0];
...
int Pieces::VerticalInitalPosition ( int PieceToDraw, int PossibleRotations){ 
  ...
  return InitialPosition [PieceToDraw][PossibleRotations][1];
